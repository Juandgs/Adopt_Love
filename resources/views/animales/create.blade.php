                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                                <div class="form-group">
                                    <strong>Raza:</strong>
                                    <input type="text" name="raza" class="form-control" placeholder="Raza del animal" >
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <img id="imagenSeleccionada" style="max-height: 300px;" class="mb-2">
...
<!-- Script para ver la imagen antes de CREAR UN NUEVO ANIMAL -->
